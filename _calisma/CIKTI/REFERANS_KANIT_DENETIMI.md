...
|---|---|---|---|
| Fine 2012 | `2012014618` | "Metaphysical grounding : understanding the structure of reality" (2012) | **PASS (loc)** |
...
Xunzi (Knoblock) HT'de kaldı (`lccn:87033578` — HT kaydı birebir). Zincir artık **IA → HathiTrust → LoC → OpenLibrary → Google Books**; by_source'ta yeni `loc` kaynağı (4 kaynak OL'den LoC'ye taşındı). Kapsam değişmedi (61/61 PASS) — kanıt güçlendi: 4 kitap artık arama-eşleşmesi (OL) değil, bağımsız ulusal katalog kaydıyla (LoC lccn) doğrulanıyor.
